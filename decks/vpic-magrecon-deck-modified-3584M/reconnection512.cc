...
begin_initialization {
  ...
  double taui    = 1000.0/wpe_wce; // simulation wci's to run
  ...
  double Lx  = 600.0/sqrt(mi_me)*di;   // size of box in x dimension
  ...
  int tracer_interval = 20*interval;
  int tracer_pass1_interval = 20*interval;
  int tracer_pass2_interval = 20*interval;
  int fields_interval = 20*interval;
  int ehydro_interval = 20*interval;
  int Hhydro_interval = 20*interval;
  int eparticle_interval = 200;
  int Hparticle_interval = 200;
